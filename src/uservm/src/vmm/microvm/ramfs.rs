...
impl RamFs {
    ...
    pub fn load_into_virtual_memory(
        ...
        // Transfer RAMFS data into guest memory (zero-copy file mapping on both platforms).
    ...
    fn map_file_into_guest(
        ...
        // Zero-copy remap: replaces [base, base + length) of guest memory with a file-backed
        // view via MapViewOfFile3 with MEM_REPLACE_PLACEHOLDER.
