...
::static_assert::assert_eq_size!(LookupMessage, ProcessManagementMessage::PAYLOAD_SIZE);
...
::static_assert::assert_eq_size!(LookupResponseMessage, ProcessManagementMessage::PAYLOAD_SIZE);
