...
// A GDT entry is 8 bytes on both x86 and x86_64. The 16-byte system descriptors (TSS/LDT) on
// x86_64 occupy two consecutive 8-byte entries (see `GdtEntries::TssLow`/`TssHigh`).
