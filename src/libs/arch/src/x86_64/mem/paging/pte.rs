...
/// # Description
///
/// A type that represents flags of a page table entry (64-bit).
///
#[derive(Debug)]
...
impl PageTableEntryFlags {
    ...
    fn from_raw_value(value: u64) -> Self {
        Self {
            ...
            global: GlobalFlag::from_raw_value(value),
    ...
    fn into_raw_value(self) -> u64 {
        ...
        value |= self.global.into_raw_value();
...
/// # Description
///
/// A type that represents a page table entry (leaf level of 4-level paging).
/// Each PTE maps a single 4 KB page.
///
#[derive(Debug)]
...
impl PageTableEntry {
    ...
    pub fn set_no_execute(&mut self, no_execute: NoExecuteFlag) {
        self.flags.no_execute = no_execute;
    }
}
