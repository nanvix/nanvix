...
/// # Description
///
/// Non-locking variant of [`feof`]. Nanvix streams are single-threaded, so this is exactly
/// equivalent to [`feof`].
///
/// # Parameters
///
...
/// # Returns
///
/// Non-zero if the end-of-file indicator is set for `stream`, otherwise zero.
///
/// # Safety
///
/// This function is unsafe because it dereferences raw pointers. The caller must ensure that
