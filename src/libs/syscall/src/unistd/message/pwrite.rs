...
#[derive(Debug)]
#[repr(C, packed)]
pub struct PositionedWriteRequest {
    pub fd: i32,
    pub count: u32,
    pub offset: off_t,
    _padding: [u8; Self::PADDING_SIZE],
}
::static_assert::assert_eq_size!(PositionedWriteRequest, LinuxDaemonMessage::PAYLOAD_SIZE);

impl PositionedWriteRequest {
    ...
    pub fn build(tid: ThreadIdentifier, fd: i32, count: c_size_t, offset: off_t) -> Message {
        let message: PositionedWriteRequest = PositionedWriteRequest::new(fd, count, offset);
