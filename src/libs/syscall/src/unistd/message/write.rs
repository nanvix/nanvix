...
impl WriteRequest {
    ...
    pub fn build(
        ...
        let message: SystemCallMessage =
            SystemCallMessage::new(SystemCallMessageKind::WriteRequest, message.into_bytes());
...
impl WriteResponse {
    ...
    pub fn build(
        ...
        let message: SystemCallMessage =
            SystemCallMessage::new(SystemCallMessageKind::WriteResponse, message.into_bytes());
        let message: Message = Message::new(
