...
/// variadic list terminated by a null pointer. The executable is located using the same rules as
/// [`execvp()`], and the current environment is inherited.
///
/// # Parameters
///
/// - `file`: Null-terminated name or path of the executable image.
