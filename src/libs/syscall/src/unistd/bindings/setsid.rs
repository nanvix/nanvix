...
/// # Description
///
/// Creates a new session if the calling process is not a process group leader. This is routed to
/// the process manager daemon, which makes the caller the leader of a brand-new session and process
/// group.
///
/// # Returns
///
