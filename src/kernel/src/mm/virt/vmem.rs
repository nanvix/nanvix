...
impl Vmem {
    ...
    ///
    pub fn map_kpage<T: Fn() -> Result<PageTableStorage, Error>>(
        &mut self,
        kpage: KernelPage,
        ...
        self.page_map
            .map_kernel_page(kpage.frame_address(), vaddr, page_table_allocator)?;
    ...
    ///
    pub fn map_mmio_page<T: Fn() -> Result<PageTableStorage, Error>>(
        &mut self,
        frame: FrameAddress,
        vaddr: PageAligned<VirtualAddress>,
        page_table_allocator: T,
        ...
        self.page_map
            .map_kernel_page(frame, vaddr, page_table_allocator)?;
    ...
    pub fn map<T: Fn() -> Result<PageTableStorage, Error>>(
        &mut self,
        uframe: UserFrame,
        vaddr: PageAligned<VirtualAddress>,
        ...
        self.page_map
            .map_user_page(vaddr, uframe.address(), access, page_table_allocator)?;
