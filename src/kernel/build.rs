...
fn main() {
    ...
    let asm_constants: String = format!(
        "// Auto-generated by build.rs — do not edit.\npub const KSTACK_SIZE: usize = \
         {kstack_size};\npub const KREDZONE_SIZE: usize = {kredzone_size};\npub const \
         KSTACK_GUARD_PATTERN: u32 = {kstack_guard_pattern:#x};\n",
    );
    fs::write(Path::new(&out_dir).join("asm_constants.rs"), asm_constants)
        .expect("Failed to write asm_constants.rs");
