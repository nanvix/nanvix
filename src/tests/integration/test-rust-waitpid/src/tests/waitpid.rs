...
pub fn run() -> Result<(), Error> {
    ::syslog::info!("test-rust-waitpid: starting waitpid() regression tests");

    test_echild_without_children()?;
    ::syslog::info!("test-rust-waitpid: PASS - echild_without_children");

    test_einval_rejects_bad_options()?;
    ::syslog::info!("test-rust-waitpid: PASS - einval_rejects_bad_options");

    test_wnohang_then_reap()?;
    ::syslog::info!("test-rust-waitpid: PASS - wnohang_then_reap");

    test_wait_any_drains_children()?;
    ::syslog::info!("test-rust-waitpid: PASS - wait_any_drains_children");

    test_orphan_adopted_by_init()?;
    ::syslog::info!("test-rust-waitpid: PASS - orphan_adopted_by_init");
