...
pub fn run() -> Result<(), Error> {
    ::syslog::info!("setenv-rust: starting fork() environment isolation tests");

    test_child_inherits_environment()?;
    ::syslog::info!("setenv-rust: PASS - child_inherits_environment");

    test_child_mutations_isolated()?;
    ::syslog::info!("setenv-rust: PASS - child_mutations_isolated");

    test_parent_mutations_isolated()?;
    ::syslog::info!("setenv-rust: PASS - parent_mutations_isolated");
