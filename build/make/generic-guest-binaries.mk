...
STANDALONE_GUEST_BINARIES := file-rust fork-rust linux-app thread-rust stress-rust arch-rust mount-test mount-multipart-test mount-bench-nostd cmdline-len-rust network-rust
