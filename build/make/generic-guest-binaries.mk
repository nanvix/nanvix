...
STANDALONE_GUEST_BINARIES := file-rust test-fork-guestfs test-fork-hostfs test-fork-kcall linux-app thread-rust stress-rust arch-rust mount-test mount-multipart-test mount-bench-nostd cmdline-len-rust network-rust
