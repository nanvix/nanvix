...
% Provided interface.
The memory management subsystem maintains memory regions on a global table and exports a well to other subsystems a well defined interface for dealing with them. Some routines provided by this interface are listed in Table (??) and briefly detailed next. 
