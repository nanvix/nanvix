...
This guide will help you set up your development environment to build and run Nanvix. Choose the
guide that matches your host operating system:

- **[Linux Setup](setup-linux.md)** — Full development workflow on Ubuntu 24.04. All components
